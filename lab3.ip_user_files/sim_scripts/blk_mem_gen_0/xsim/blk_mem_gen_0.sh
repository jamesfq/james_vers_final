...
#
# Generated by Vivado on Mon Jun 02 15:26:50 -0400 2025
...
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5de7.protoinst" -protoinst "protoinst_files/axi_stream_bd.protoinst" -log simulate.log
}
