...
#
# Generated by export_simulation on Wed May 07 14:51:31 -0400 2025
#
################################################################################
...
'-reset_run' switch to the './fir_hpf_0.sh' script.

./fir_hpf_0.sh -reset_run
...
./fir_hpf_0.sh -noclean_files

For more information on the script, please type './fir_hpf_0.sh -help'.
