...
#
# Generated by export_simulation on Mon May 12 11:09:39 -0400 2025
#
################################################################################
...
'-reset_run' switch to the './fir_lpf_0.sh' script.

./fir_lpf_0.sh -reset_run
...
./fir_lpf_0.sh -noclean_files

For more information on the script, please type './fir_lpf_0.sh -help'.
