...
#
# Generated by export_simulation on Wed May 07 15:02:26 -0400 2025
#
################################################################################
...
'-reset_run' switch to the './fir_bsf_0.sh' script.

./fir_bsf_0.sh -reset_run
...
./fir_bsf_0.sh -noclean_files

For more information on the script, please type './fir_bsf_0.sh -help'.
