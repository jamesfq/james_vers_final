...
#
# Generated by export_simulation on Wed May 07 14:55:50 -0400 2025
#
################################################################################
...
'-reset_run' switch to the './fir_bpf_0.sh' script.

./fir_bpf_0.sh -reset_run
...
./fir_bpf_0.sh -noclean_files

For more information on the script, please type './fir_bpf_0.sh -help'.
