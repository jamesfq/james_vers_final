...
HD_PWD='O:/ENGS128/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_stream_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_stream_bd_wrapper.tcl -notrace
