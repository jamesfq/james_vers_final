...
HD_PWD='O:/ENGS128/lab3/lab3.runs/axi_stream_bd_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_stream_bd_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_stream_bd_xbar_1.tcl
