...
----------------------------------------------------------------------------
-- Entity definition
entity tb_bulk_fifo_to_fifo is
end tb_bulk_fifo_to_fifo;

----------------------------------------------------------------------------
-- Architecture Definition 
architecture testbench of tb_bulk_fifo_to_fifo is
----------------------------------------------------------------------------
...
fifo_0_adc_to_fifo: axis_bulk_fifo
port map (
...
fifo_1_fifo_to_spi: axis_bulk_fifo
port map (
