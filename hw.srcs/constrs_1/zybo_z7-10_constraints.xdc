...
## Switches
## -----------------------------------------------------------------------------------------------------------------------------------------------------------
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 			} [get_ports { fir_sel_i[0]		}]; #IO_L19N_T3_VREF_35 		Sch=sw[0]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 			} [get_ports { fir_sel_i[1]			}]; #IO_L24P_T3_34 				Sch=sw[1]
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 			} [get_ports { fir_sel_i[2]			}]; #IO_L4N_T0_34 				Sch=sw[2]
...
## --------------------------------------------- { btn[2] 		 		}]; #IO_L10P_T1_AD11P_35 		Sch=btn[2]
